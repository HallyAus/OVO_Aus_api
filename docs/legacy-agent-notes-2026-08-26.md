# Legacy agent notes — archived 2026-08-26

Superseded by `AGENTS.md`. Kept verbatim for the full architecture map, the
step-by-step Auth0 flow, and the exact release-zip command.
