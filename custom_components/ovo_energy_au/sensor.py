...
async def async_setup_entry(
    ...
    sensors = [
        ...
        OVOEnergyAUSensor(
            ...
            SensorStateClass.TOTAL,
            "mdi:ev-station",
            lambda data: data.get("daily", {}).get("rate_breakdown", {}).get("ev_offpeak_consumption", 0),
            "Yesterday",
        ),
        OVOEnergyAUSensor(
            coordinator,
            "daily_ev_offpeak_charge",
            "EV Off-Peak Charge",
            "AUD",
            SensorDeviceClass.MONETARY,
            SensorStateClass.TOTAL,
            "mdi:currency-usd",
            lambda data: data.get("daily", {}).get("rate_breakdown", {}).get("ev_offpeak_charge", 0),
            "Yesterday",
        ),
        OVOEnergyAUSensor(
            coordinator,
            ...
            SensorStateClass.TOTAL,
            "mdi:solar-power",
            lambda data: data.get("daily", {}).get("rate_breakdown", {}).get("free_3_consumption", 0),
            "Yesterday",
        ),
        OVOEnergyAUSensor(
            coordinator,
            ...
            SensorStateClass.TOTAL,
            "mdi:currency-usd",
            lambda data: data.get("daily", {}).get("rate_breakdown", {}).get("free_3_charge", 0),
            "Yesterday",
        ),
        OVOEnergyAUSensor(
            coordinator,
            ...
            SensorStateClass.TOTAL,
            "mdi:lightning-bolt",
            lambda data: data.get("daily", {}).get("rate_breakdown", {}).get("other_consumption", 0),
            "Yesterday",
        ),
        OVOEnergyAUSensor(
            coordinator,
            ...
            SensorStateClass.TOTAL,
            "mdi:currency-usd",
            lambda data: data.get("daily", {}).get("rate_breakdown", {}).get("other_charge", 0),
            "Yesterday",
        ),
        ...
        OVOEnergyAUSensor(
            ...
            SensorStateClass.TOTAL,
            "mdi:ev-station",
            lambda data: data.get("yearly", {}).get("rate_breakdown", {}).get("ev_offpeak_consumption", 0),
            "This Year",
        ),
        OVOEnergyAUSensor(
            coordinator,
            "yearly_ev_offpeak_charge",
            "EV Off-Peak Charge",
            "AUD",
            SensorDeviceClass.MONETARY,
            SensorStateClass.TOTAL,
            "mdi:currency-usd",
            lambda data: data.get("yearly", {}).get("rate_breakdown", {}).get("ev_offpeak_charge", 0),
            "This Year",
        ),
        OVOEnergyAUSensor(
            coordinator,
            ...
            SensorStateClass.TOTAL,
            "mdi:solar-power",
            lambda data: data.get("yearly", {}).get("rate_breakdown", {}).get("free_3_consumption", 0),
            "This Year",
        ),
        OVOEnergyAUSensor(
            coordinator,
            "yearly_free_3_charge",
            "Free Period Charge",
            "AUD",
            SensorDeviceClass.MONETARY,
            SensorStateClass.TOTAL,
            "mdi:currency-usd",
            lambda data: data.get("yearly", {}).get("rate_breakdown", {}).get("free_3_charge", 0),
            "This Year",
        ),
        OVOEnergyAUSensor(
            coordinator,
            ...
            SensorStateClass.TOTAL,
            "mdi:lightning-bolt",
            lambda data: data.get("yearly", {}).get("rate_breakdown", {}).get("other_consumption", 0),
            "This Year",
        ),
        OVOEnergyAUSensor(
            coordinator,
            ...
            SensorStateClass.TOTAL,
            "mdi:currency-usd",
            lambda data: data.get("yearly", {}).get("rate_breakdown", {}).get("other_charge", 0),
            "This Year",
        ),
